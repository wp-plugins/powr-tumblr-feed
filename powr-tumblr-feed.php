<?php
    ...
    Description: Create a custom Tumblr feed in seconds! Add the widget to your theme, or create a Tumblr Feed on ANY page or post by using the shortcode [powr-tumblr-feed]. Then, simply visit your site and click the settings icon to customize your Tumblr Feed right in the page. Many more plugins & tutorials at POWr.io.
    Author: POWr.io
    Version: 1.1
    ...
    */
    ...
    class Powr_Tumblr_Feed extends WP_Widget{
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your Tumblr Feed.
        </p>
        <p>
